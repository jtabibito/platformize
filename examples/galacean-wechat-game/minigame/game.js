...
var $URL = /*#__PURE__*/ function() {
    ...
    _proto.createObjectURL = function createObjectURL(obj) {
        if (_instanceof$2(obj, $Blob)) {
            ...
            var base64 = encode$1(obj.parts[0]);
...
var isArray = Array.isArray, URLSearchParamsProto = $URLSearchParams.prototype, find = /[!'\(\)~]|%20|%00/g, plus = /\+/g, replace = {
    "!": "%21",
    "'": "%27",
    "(": "%28",
    ")": "%29",
...
function addEach(value, key) {
    /* jshint validthis:true */ appendTo(this, key, value);
}
...
var WechatGamePlatform = /*#__PURE__*/ function(WechatGamePlatformBase1) {
    ...
    function WechatGamePlatform(canvas, width, height) {
        ...
        _this.polyfill.window["Blob"] = $window$1.Blob;
        _this.polyfill.window["setTimeout"] = $window$1.setTimeout;
        _this.polyfill.Blob = _this.polyfill.window["Blob"];
        _this.polyfill.OffscreenCanvas = OffscreenCanvas;
        _this.polyfill.window["URLSearchParams"] = $URLSearchParams;
        _this.polyfill.URLSearchParams = $URLSearchParams;
...
}(), _ControlFreePointer._deltaType = 0, _ControlFreePointer._handlerType = ControlHandlerType.None, _ControlFreePointer._frameIndex = 0, _ControlFreePointer._lastUsefulFrameIndex = -1, _ControlFreePointer);
...
}(), _ControlPointer._deltaType = 2, _ControlPointer._handlerType = ControlHandlerType.None, _ControlPointer._frameIndex = 0, _ControlPointer._lastUsefulFrameIndex = -1, _ControlPointer._distanceOfPointers = 0, _ControlPointer);
